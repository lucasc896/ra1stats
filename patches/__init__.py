...
def cutFunc() :
    return {"T1":lambda iX,x,iY,y,iZ,z:(y<(x-150.1) and iZ==1 and x>287.4),
            ...
            "T2tt":lambda iX,x,iY,y,iZ,z:(y<(x-75.1) and iZ==1 and x>100.0 and x<1000.0 and x<780.1 and y<300.1), #@@ hack!
            ...
            "T2bw_0p25":lambda iX,x,iY,y,iZ,z:(y<(x-75.1) and iZ==1 and x>99. and x<800.1 and x<600.1 and y<350.1), #@@ hack!
            "T2bw_0p75":lambda iX,x,iY,y,iZ,z:(y<(x-75.1) and iZ==1 and x>99. and x<800.1 and x<750.1 and y<300.1), #@@ hack!
